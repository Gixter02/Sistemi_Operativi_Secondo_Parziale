...
int main ()
{
	...
	{ 	/* figlio */
		...
		int n;
		printf("Dammi il numero che vuoi inserire:\t");
		scanf("%d", &n);
		if(n < 0 || n > 255)
			printf("Il numero verra' troncato");
		exit(n);	/* si torna un valore che si suppone possa essere derivante dall'esecuzione di un compito assegnato al figlio */
	}
