...
int main(int argc, char **argv) 
{
	...
	int nro;		/* variabile per tenere traccia del numero di blocchi letti dalla propria meta' del file */
...
pipe_ps=(pipe_t *)malloc(N*sizeof(pipe_t));     /* ps sta per dal primo al secondo processo */
if (pipe_ps == NULL)
{
